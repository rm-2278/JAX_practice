...
class Decoder(nnx.Module):
    ...
    def __call__(self, z):
        return nnx.sigmoid(self.fc2(nnx.relu(self.fc1(z))))
    
class VAE(nnx.Module):
    def __init__(self, din, dmid, dlatent, rngs):
        self.encoder = Encoder(din, dmid, dlatent, rngs=rngs)
        self.decoder = Decoder(dmid, din, dlatent, rngs=rngs)
...
model = VAE(784, 256, 32, nnx.Rngs(0))
